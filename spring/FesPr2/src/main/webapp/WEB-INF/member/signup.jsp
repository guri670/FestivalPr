		...
		<form name="frm">
			...
			<div class="mb-3">
				<label for="confirm-password" class="form-label">비밀번호 확인</label> <input
					type="password" class="form-control" name="memberPassword2"
			...
			<div class="mb-3">
				<label for="name" class="form-label">이름</label> <input type="text"
					class="form-control" name="memberName" placeholder="이름을 입력하세요">
			</div>
			...
			<div class="mb-3 row">
				<div class="col">
					<label for="birth" class="form-label">생년월일</label> <input
						class="form-control" name="memberBirthday"
			...
			<div class="mb-3">
				<label for="phone" class="form-label">연락처</label> <input type="text"
					class="form-control" name="memberPhone" placeholder="'-' 없이 입력해주세요">
